...
[`sentry::init`]: https://docs.rs/sentry/0.48.2/sentry/fn.init.html
[`Hub`]: https://docs.rs/sentry/0.48.2/sentry/struct.Hub.html
...
[Features]: #features
[integrations]: https://docs.rs/sentry/0.48.2/sentry/integrations/index.html
[apply_defaults]: https://docs.rs/sentry/0.48.2/sentry/fn.apply_defaults.html
...
[`Integration`]: https://docs.rs/sentry/0.48.2/sentry/trait.Integration.html
[`Transport`]: https://docs.rs/sentry/0.48.2/sentry/trait.Transport.html
...
### Metrics
- `metrics`: Enables [`sentry::metrics`](https://docs.rs/sentry/0.48.2/sentry/crate::metrics) APIs for counters, gauges, and
  distributions.
